...
class Philox(__numpy_random_bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001F704A15490>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001F7040AED50>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._philox', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001F7040AED50>, origin='C:\\\\Users\\\\T14\\\\PyCharmMiscProject\\\\.venv\\\\Lib\\\\site-packages\\\\numpy\\\\random\\\\_philox.cp314-win_amd64.pyd')"

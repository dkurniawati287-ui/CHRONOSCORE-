...
class PCG64(__numpy_random_bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001CBDF2A75B0>'
...
class PCG64DXSM(__numpy_random_bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001CBDF2A7830>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001CBDF27C120>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._pcg64', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001CBDF27C120>, origin='C:\\\\Users\\\\T14\\\\PyCharmMiscProject\\\\.venv\\\\Lib\\\\site-packages\\\\numpy\\\\random\\\\_pcg64.cp314-win_amd64.pyd')"

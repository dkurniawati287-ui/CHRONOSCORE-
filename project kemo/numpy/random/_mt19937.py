...
class MT19937(__numpy_random_bit_generator.BitGenerator):
    ...
    def __init__(self, s): # real signature unknown; restored from __doc__
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001997A595A80>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000019979BFEC90>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._mt19937', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000019979BFEC90>, origin='C:\\\\Users\\\\T14\\\\PyCharmMiscProject\\\\.venv\\\\Lib\\\\site-packages\\\\numpy\\\\random\\\\_mt19937.cp314-win_amd64.pyd')"

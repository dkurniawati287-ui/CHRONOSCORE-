...
def always_error_unary(x, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    always_error_unary(x, /, out=None, *, where=True, casting='same_kind', order='K', dtype=None, subok=True[, signature])
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002D9CFB81D60>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy._core._umath_tests', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002D9CFB81D60>, origin='C:\\\\Users\\\\T14\\\\PyCharmMiscProject\\\\.venv\\\\Lib\\\\site-packages\\\\numpy\\\\_core\\\\_umath_tests.cp314-win_amd64.pyd')"

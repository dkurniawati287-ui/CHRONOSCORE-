# encoding: utf-8
# module numpy._core._rational_tests
# from C:\Users\T14\PyCharmMiscProject\.venv\Lib\site-packages\numpy\_core\_rational_tests.cp314-win_amd64.pyd
# by generator 1.147
# no doc
...
def denominator(x, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    denominator(x, /, out=None, *, where=True, casting='same_kind', order='K', dtype=None, subok=True[, signature])
...
def numerator(x, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    numerator(x, /, out=None, *, where=True, casting='same_kind', order='K', dtype=None, subok=True[, signature])
...
def test_add(x1, x2, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    test_add(x1, x2, /, out=None, *, where=True, casting='same_kind', order='K', dtype=None, subok=True[, signature])
...
def test_add_rationals(x1, x2, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    test_add_rationals(x1, x2, /, out=None, *, where=True, casting='same_kind', order='K', dtype=None, subok=True[, signature])
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001DAC13B1D60>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy._core._rational_tests', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001DAC13B1D60>, origin='C:\\\\Users\\\\T14\\\\PyCharmMiscProject\\\\.venv\\\\Lib\\\\site-packages\\\\numpy\\\\_core\\\\_rational_tests.cp314-win_amd64.pyd')"

...
# from C:\Users\T14\PyCharmMiscProject\.venv\Lib\site-packages\pandas\_libs\tslibs\strptime.cp314-win_amd64.pyd
# by generator 1.147
"""
...
class DatetimeParseState(object):
    # no doc
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x00000183D7535800>'
...
class LocaleTime(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_strptime', '__firstlineno__': 68, '__doc__': 'Stores and handles locale-specific information related to time.\\n\\nATTRIBUTES:\\n    f_weekday -- full weekday names (7-item list)\\n    a_weekday -- abbreviated weekday names (7-item list)\\n    f_month -- full month names (13-item list; dummy value in [0], which\\n                is added by code)\\n    a_month -- abbreviated month names (13-item list, dummy value in\\n                [0], which is added by code)\\n    am_pm -- AM/PM representation (2-item list)\\n    LC_date_time -- format string for date/time representation (string)\\n    LC_date -- format string for date representation (string)\\n    LC_time -- format string for time representation (string)\\n    timezone -- daylight- and non-daylight-savings timezone representation\\n                (2-item list of sets)\\n    lang -- Language used by instance (2-item tuple)\\n', '__init__': <function LocaleTime.__init__ at 0x00000183D74E2F00>, '_LocaleTime__calc_weekday': <function LocaleTime.__calc_weekday at 0x00000183D74E2FB0>, '_LocaleTime__calc_month': <function LocaleTime.__calc_month at 0x00000183D74E3060>, '_LocaleTime__calc_am_pm': <function LocaleTime.__calc_am_pm at 0x00000183D74E3110>, '_LocaleTime__calc_alt_digits': <function LocaleTime.__calc_alt_digits at 0x00000183D74E31C0>, '_LocaleTime__calc_date_time': <function LocaleTime.__calc_date_time at 0x00000183D74E3270>, '_LocaleTime__find_month_format': <function LocaleTime.__find_month_format at 0x00000183D74E3320>, '_LocaleTime__find_weekday_format': <function LocaleTime.__find_weekday_format at 0x00000183D74E33D0>, '_LocaleTime__calc_timezone': <function LocaleTime.__calc_timezone at 0x00000183D74E3480>, '__static_attributes__': ('LC_alt_digits', 'LC_date', 'LC_date_time', 'LC_time', 'LC_time_ampm', 'a_month', 'a_weekday', 'am_pm', 'daylight', 'f_month', 'f_weekday', 'lang', 'timezone', 'tzname'), '__dict__': <attribute '__dict__' of 'LocaleTime' objects>, '__weakref__': <attribute '__weakref__' of 'LocaleTime' objects>})"
    __firstlineno__ = 68
...
class _TimeRE(dict):
    ...
    def _TimeRE__seqToRE(self, to_convert, directive, altregex=None): # reliably restored by inspect
        """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_strptime', '__firstlineno__': 340, '__doc__': 'Handle conversion from format directives to regexes.', '__init__': <function TimeRE.__init__ at 0x00000183D74E3530>, '_TimeRE__seqToRE': <function TimeRE.__seqToRE at 0x00000183D74E35E0>, 'pattern': <function TimeRE.pattern at 0x00000183D74E3690>, 'compile': <function TimeRE.compile at 0x00000183D74E3740>, '__static_attributes__': ('locale_time',), '__dict__': <attribute '__dict__' of 'TimeRE' objects>, '__weakref__': <attribute '__weakref__' of 'TimeRE' objects>})"
    __firstlineno__ = 340
    __static_attributes__ = (
        'locale_time',
    )
...
class Timestamp(__pandas__libs_tslibs_timestamps._Timestamp):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas\', \'__doc__\': "\\n    Pandas replacement for python datetime.datetime object.\\n\\n    Timestamp is the pandas equivalent of python\'s Datetime\\n    and is interchangeable with it in most cases. It\'s the type used\\n    for the entries that make up a DatetimeIndex, and other timeseries\\n    oriented data structures in pandas.\\n\\n    Parameters\\n    ----------\\n    ts_input : datetime-like, str, int, float\\n        Value to be converted to Timestamp.\\n    year : int\\n        Value of year.\\n    month : int\\n        Value of month.\\n    day : int\\n        Value of day.\\n    hour : int, optional, default 0\\n        Value of hour.\\n    minute : int, optional, default 0\\n        Value of minute.\\n    second : int, optional, default 0\\n        Value of second.\\n    microsecond : int, optional, default 0\\n        Value of microsecond.\\n    tzinfo : datetime.tzinfo, optional, default None\\n        Timezone info.\\n    nanosecond : int, optional, default 0\\n        Value of nanosecond.\\n    tz : str, zoneinfo.ZoneInfo, pytz.timezone, dateutil.tz.tzfile or None\\n        Time zone for time which Timestamp will have.\\n    unit : str\\n        Unit used for conversion if ts_input is of type int or float. The\\n        valid values are \'W\', \'D\', \'h\', \'m\', \'s\', \'ms\', \'us\', and \'ns\'. For\\n        example, \'s\' means seconds and \'ms\' means milliseconds.\\n\\n        For float inputs, the result will be stored in nanoseconds, and\\n        the unit attribute will be set as ``\'ns\'``.\\n    fold : {0, 1}, default None, keyword-only\\n        Due to daylight saving time, one wall clock time can occur twice\\n        when shifting from summer to winter time; fold describes whether the\\n        datetime-like corresponds  to the first (0) or the second time (1)\\n        the wall clock hits the ambiguous time.\\n\\n    See Also\\n    --------\\n    Timedelta : Represents a duration, the difference between two dates or times.\\n    datetime.datetime : Python datetime.datetime object.\\n\\n    Notes\\n    -----\\n    There are essentially three calling conventions for the constructor. The\\n    primary form accepts four parameters. They can be passed by position or\\n    keyword.\\n\\n    The other two forms mimic the parameters from ``datetime.datetime``. They\\n    can be passed by either position or keyword, but not both mixed together.\\n\\n    Examples\\n    --------\\n    Using the primary calling convention:\\n\\n    This converts a datetime-like string\\n\\n    >>> pd.Timestamp(\'2017-01-01T12\')\\n    Timestamp(\'2017-01-01 12:00:00\')\\n\\n    This converts a float representing a Unix epoch in units of seconds\\n\\n    >>> pd.Timestamp(1513393355.5, unit=\'s\')\\n    Timestamp(\'2017-12-16 03:02:35.500000\')\\n\\n    This converts an int representing a Unix-epoch in units of weeks\\n\\n    >>> pd.Timestamp(1535, unit=\'W\')\\n    Timestamp(\'1999-06-03 00:00:00\')\\n\\n    This converts an int representing a Unix-epoch in units of seconds\\n    and for a particular timezone\\n\\n    >>> pd.Timestamp(1513393355, unit=\'s\', tz=\'US/Pacific\')\\n    Timestamp(\'2017-12-15 19:02:35-0800\', tz=\'US/Pacific\')\\n\\n    Using the other two forms that mimic the API for ``datetime.datetime``:\\n\\n    >>> pd.Timestamp(2017, 1, 1, 12)\\n    Timestamp(\'2017-01-01 12:00:00\')\\n\\n    >>> pd.Timestamp(year=2017, month=1, day=1, hour=12)\\n    Timestamp(\'2017-01-01 12:00:00\')\\n    ", \'fromordinal\': <classmethod(<cyfunction Timestamp.fromordinal at 0x00000183D74B5C70>)>, \'now\': <classmethod(<cyfunction Timestamp.now at 0x00000183D74B5D60>)>, \'today\': <classmethod(<cyfunction Timestamp.today at 0x00000183D74B5E50>)>, \'utcnow\': <classmethod(<cyfunction Timestamp.utcnow at 0x00000183D74B5F40>)>, \'utcfromtimestamp\': <classmethod(<cyfunction Timestamp.utcfromtimestamp at 0x00000183D74B6030>)>, \'fromtimestamp\': <classmethod(<cyfunction Timestamp.fromtimestamp at 0x00000183D74B6120>)>, \'strftime\': <cyfunction Timestamp.strftime at 0x00000183D74B6210>, \'ctime\': <cyfunction Timestamp.ctime at 0x00000183D74B6300>, \'date\': <cyfunction Timestamp.date at 0x00000183D74B63F0>, \'dst\': <cyfunction Timestamp.dst at 0x00000183D74B64E0>, \'isocalendar\': <cyfunction Timestamp.isocalendar at 0x00000183D74B65D0>, \'tzname\': <cyfunction Timestamp.tzname at 0x00000183D74B66C0>, \'tzinfo\': <property object at 0x00000183D7403920>, \'utcoffset\': <cyfunction Timestamp.utcoffset at 0x00000183D74B68A0>, \'utctimetuple\': <cyfunction Timestamp.utctimetuple at 0x00000183D74B6990>, \'time\': <cyfunction Timestamp.time at 0x00000183D74B6A80>, \'timetuple\': <cyfunction Timestamp.timetuple at 0x00000183D74B6B70>, \'timetz\': <cyfunction Timestamp.timetz at 0x00000183D74B6C60>, \'toordinal\': <cyfunction Timestamp.toordinal at 0x00000183D74B6D50>, \'strptime\': <classmethod(<cyfunction Timestamp.strptime at 0x00000183D74B6E40>)>, \'combine\': <classmethod(<cyfunction Timestamp.combine at 0x00000183D74B6F30>)>, \'__new__\': <staticmethod(<cyfunction Timestamp.__new__ at 0x00000183D74B7020>)>, \'_round\': <cyfunction Timestamp._round at 0x00000183D74B7110>, \'round\': <cyfunction Timestamp.round at 0x00000183D74B7200>, \'floor\': <cyfunction Timestamp.floor at 0x00000183D74B72F0>, \'ceil\': <cyfunction Timestamp.ceil at 0x00000183D74B73E0>, \'tz\': <property object at 0x00000183D7403830>, \'tz_localize\': <cyfunction Timestamp.tz_localize at 0x00000183D74B76B0>, \'tz_convert\': <cyfunction Timestamp.tz_convert at 0x00000183D74B77A0>, \'astimezone\': <cyfunction Timestamp.tz_convert at 0x00000183D74B77A0>, \'replace\': <cyfunction Timestamp.replace at 0x00000183D74B7890>, \'to_julian_date\': <cyfunction Timestamp.to_julian_date at 0x00000183D74B7980>, \'isoweekday\': <cyfunction Timestamp.isoweekday at 0x00000183D74B7A70>, \'weekday\': <cyfunction Timestamp.weekday at 0x00000183D74B7B60>, \'__dict__\': <attribute \'__dict__\' of \'Timestamp\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Timestamp\' objects>, \'_module_source\': \'pandas._libs.tslibs.timestamps\', \'weekofyear\': <attribute \'week\' of \'pandas._libs.tslibs.timestamps._Timestamp\' objects>, \'daysinmonth\': <attribute \'days_in_month\' of \'pandas._libs.tslibs.timestamps._Timestamp\' objects>})'
...
_TimeRE_cache = {
    ...
    'Oy': '',
    'P': '(?P<p>am|pm)',
    'R': '(?P<H>2[0-3]|[0-1]\\d|\\d| \\d):(?P<M>[0-5]\\d|\\d)',
    'S': '(?P<S>6[0-1]|[0-5]\\d|\\d)',
    'T': '(?P<H>2[0-3]|[0-1]\\d|\\d| \\d):(?P<M>[0-5]\\d|\\d):(?P<S>6[0-1]|[0-5]\\d|\\d)',
    'U': '(?P<U>5[0-3]|[0-4]\\d|\\d)',
    'V': '(?P<V>5[0-3]|0[1-9]|[1-4]\\d|\\d)',
    'W': '(?P<W>5[0-3]|[0-4]\\d|\\d)',
    'X': '(?P<H>2[0-3]|[0-1]\\d|\\d| \\d):(?P<M>[0-5]\\d|\\d):(?P<S>6[0-1]|[0-5]\\d|\\d)',
    'Y': '(?P<Y>\\d\\d\\d\\d)',
Riyadh|US/Aleutian|US/Mountain|Asia/Manila|Asia/Yangon|Brazil/West|Europe/Kyiv|Asia/Aqtau|Etc/GMT\\+10|Etc/GMT\\-10|Asia/Tokyo|Asia/Dubai|Asia/Kabul|Etc/GMT\\+12|US/Pacific|Asia/Qatar|Asia/Macao|Etc/GMT\\-12|Asia/Chita|Asia/Amman|Etc/GMT\\-14|US/Eastern|Etc/GMT\\-11|Asia/Seoul|US/Arizona|Asia/Dacca|Etc/GMT\\-13|Asia/Tomsk|Asia/Macau|Etc/GMT\\+11|US/Central|Asia/Dhaka|Asia/Aden|Etc/GMT\\+3|Kwajalein|Etc/GMT\\+2|Etc/GMT\\+7|US/Alaska|Etc/GMT\\-6|Etc/GMT\\-4|Asia/Baku|Etc/GMT\\+0|Etc/GMT\\-5|Asia/Hovd|Singapore|Etc/GMT\\+5|Etc/GMT\\+8|Greenwich|Etc/GMT\\+1|Etc/GMT\\-7|Etc/GMT\\-0|Asia/Oral|Etc/GMT\\+9|Etc/GMT\\+4|Etc/GMT\\-8|Etc/GMT\\-1|Etc/GMT\\-3|US/Hawaii|Etc/GMT\\-2|Asia/Omsk|Asia/Dili|Etc/GMT\\-9|Universal|Asia/Gaza|Etc/GMT\\+6|Etc/Zulu|Hongkong|Portugal|US/Samoa|Etc/GMT0|Jamaica|Etc/UTC|PST8PDT|CST6CDT|Factory|EST5EDT|MST7MDT|Etc/UCT|NZ\\-CHAT|Iceland|GB\\-Eire|Etc/GMT|Poland|Turkey|Navajo|Israel|GMT\\-0|Egypt|GMT\\+0|Libya|Japan|Eire|Iran|Cuba|Zulu|W\\-SU|GMT0|CET|UTC|UCT|HST|PRC|ROC|MET|MST|EST|EET|ROK|WET|GMT|NZ|GB)',
    'a': '(?P<a>mon|tue|wed|thu|fri|sat|sun)',
    'b': '(?P<b>jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)',
    'c': '(?P<a>mon|tue|wed|thu|fri|sat|sun)\\s+(?P<b>jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)\\s+(?P<d>3[0-1]|[1-2]\\d|0[1-9]|[1-9]| [1-9])\\s+(?P<H>2[0-3]|[0-1]\\d|\\d| \\d):(?P<M>[0-5]\\d|\\d):(?P<S>6[0-1]|[0-5]\\d|\\d)\\s+(?P<Y>\\d\\d\\d\\d)',
    'd': '(?P<d>3[0-1]|[1-2]\\d|0[1-9]|[1-9]| [1-9])',
    'e': '(?P<d>3[0-1]|[1-2]\\d|0[1-9]|[1-9]| [1-9])',
    'f': '(?P<f>[0-9]{1,9})',
    ...
    'p': '(?P<p>am|pm)',
    'r': '(?P<I>1[0-2]|0[1-9]|[1-9]| [1-9]):(?P<M>[0-5]\\d|\\d):(?P<S>6[0-1]|[0-5]\\d|\\d)\\s+(?P<p>am|pm)',
    'u': '(?P<u>[1-7])',
    'w': '(?P<w>[0-6])',
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000183D74EE2D0>'

__pyx_capi__ = {
    'parse_today_now': None, # (!) real value is '<capsule object "int (PyObject *, __pyx_t_5numpy_int64_t *, int, NPY_DATETIMEUNIT, struct __pyx_opt_args_6pandas_5_libs_6tslibs_8strptime_parse_today_now *__pyx_optional_args)" at 0x00000183D7535670>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.strptime', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000183D74EE2D0>, origin='C:\\\\Users\\\\T14\\\\PyCharmMiscProject\\\\.venv\\\\Lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\strptime.cp314-win_amd64.pyd')"

...
class Timestamp(__pandas__libs_tslibs_timestamps._Timestamp):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas\', \'__doc__\': "\\n    Pandas replacement for python datetime.datetime object.\\n\\n    Timestamp is the pandas equivalent of python\'s Datetime\\n    and is interchangeable with it in most cases. It\'s the type used\\n    for the entries that make up a DatetimeIndex, and other timeseries\\n    oriented data structures in pandas.\\n\\n    Parameters\\n    ----------\\n    ts_input : datetime-like, str, int, float\\n        Value to be converted to Timestamp.\\n    year : int\\n        Value of year.\\n    month : int\\n        Value of month.\\n    day : int\\n        Value of day.\\n    hour : int, optional, default 0\\n        Value of hour.\\n    minute : int, optional, default 0\\n        Value of minute.\\n    second : int, optional, default 0\\n        Value of second.\\n    microsecond : int, optional, default 0\\n        Value of microsecond.\\n    tzinfo : datetime.tzinfo, optional, default None\\n        Timezone info.\\n    nanosecond : int, optional, default 0\\n        Value of nanosecond.\\n    tz : str, zoneinfo.ZoneInfo, pytz.timezone, dateutil.tz.tzfile or None\\n        Time zone for time which Timestamp will have.\\n    unit : str\\n        Unit used for conversion if ts_input is of type int or float. The\\n        valid values are \'W\', \'D\', \'h\', \'m\', \'s\', \'ms\', \'us\', and \'ns\'. For\\n        example, \'s\' means seconds and \'ms\' means milliseconds.\\n\\n        For float inputs, the result will be stored in nanoseconds, and\\n        the unit attribute will be set as ``\'ns\'``.\\n    fold : {0, 1}, default None, keyword-only\\n        Due to daylight saving time, one wall clock time can occur twice\\n        when shifting from summer to winter time; fold describes whether the\\n        datetime-like corresponds  to the first (0) or the second time (1)\\n        the wall clock hits the ambiguous time.\\n\\n    See Also\\n    --------\\n    Timedelta : Represents a duration, the difference between two dates or times.\\n    datetime.datetime : Python datetime.datetime object.\\n\\n    Notes\\n    -----\\n    There are essentially three calling conventions for the constructor. The\\n    primary form accepts four parameters. They can be passed by position or\\n    keyword.\\n\\n    The other two forms mimic the parameters from ``datetime.datetime``. They\\n    can be passed by either position or keyword, but not both mixed together.\\n\\n    Examples\\n    --------\\n    Using the primary calling convention:\\n\\n    This converts a datetime-like string\\n\\n    >>> pd.Timestamp(\'2017-01-01T12\')\\n    Timestamp(\'2017-01-01 12:00:00\')\\n\\n    This converts a float representing a Unix epoch in units of seconds\\n\\n    >>> pd.Timestamp(1513393355.5, unit=\'s\')\\n    Timestamp(\'2017-12-16 03:02:35.500000\')\\n\\n    This converts an int representing a Unix-epoch in units of weeks\\n\\n    >>> pd.Timestamp(1535, unit=\'W\')\\n    Timestamp(\'1999-06-03 00:00:00\')\\n\\n    This converts an int representing a Unix-epoch in units of seconds\\n    and for a particular timezone\\n\\n    >>> pd.Timestamp(1513393355, unit=\'s\', tz=\'US/Pacific\')\\n    Timestamp(\'2017-12-15 19:02:35-0800\', tz=\'US/Pacific\')\\n\\n    Using the other two forms that mimic the API for ``datetime.datetime``:\\n\\n    >>> pd.Timestamp(2017, 1, 1, 12)\\n    Timestamp(\'2017-01-01 12:00:00\')\\n\\n    >>> pd.Timestamp(year=2017, month=1, day=1, hour=12)\\n    Timestamp(\'2017-01-01 12:00:00\')\\n    ", \'fromordinal\': <classmethod(<cyfunction Timestamp.fromordinal at 0x000001A4FF655C70>)>, \'now\': <classmethod(<cyfunction Timestamp.now at 0x000001A4FF655D60>)>, \'today\': <classmethod(<cyfunction Timestamp.today at 0x000001A4FF655E50>)>, \'utcnow\': <classmethod(<cyfunction Timestamp.utcnow at 0x000001A4FF655F40>)>, \'utcfromtimestamp\': <classmethod(<cyfunction Timestamp.utcfromtimestamp at 0x000001A4FF656030>)>, \'fromtimestamp\': <classmethod(<cyfunction Timestamp.fromtimestamp at 0x000001A4FF656120>)>, \'strftime\': <cyfunction Timestamp.strftime at 0x000001A4FF656210>, \'ctime\': <cyfunction Timestamp.ctime at 0x000001A4FF656300>, \'date\': <cyfunction Timestamp.date at 0x000001A4FF6563F0>, \'dst\': <cyfunction Timestamp.dst at 0x000001A4FF6564E0>, \'isocalendar\': <cyfunction Timestamp.isocalendar at 0x000001A4FF6565D0>, \'tzname\': <cyfunction Timestamp.tzname at 0x000001A4FF6566C0>, \'tzinfo\': <property object at 0x000001A4FF573830>, \'utcoffset\': <cyfunction Timestamp.utcoffset at 0x000001A4FF6568A0>, \'utctimetuple\': <cyfunction Timestamp.utctimetuple at 0x000001A4FF656990>, \'time\': <cyfunction Timestamp.time at 0x000001A4FF656A80>, \'timetuple\': <cyfunction Timestamp.timetuple at 0x000001A4FF656B70>, \'timetz\': <cyfunction Timestamp.timetz at 0x000001A4FF656C60>, \'toordinal\': <cyfunction Timestamp.toordinal at 0x000001A4FF656D50>, \'strptime\': <classmethod(<cyfunction Timestamp.strptime at 0x000001A4FF656E40>)>, \'combine\': <classmethod(<cyfunction Timestamp.combine at 0x000001A4FF656F30>)>, \'__new__\': <staticmethod(<cyfunction Timestamp.__new__ at 0x000001A4FF657020>)>, \'_round\': <cyfunction Timestamp._round at 0x000001A4FF657110>, \'round\': <cyfunction Timestamp.round at 0x000001A4FF657200>, \'floor\': <cyfunction Timestamp.floor at 0x000001A4FF6572F0>, \'ceil\': <cyfunction Timestamp.ceil at 0x000001A4FF6573E0>, \'tz\': <property object at 0x000001A4FF573740>, \'tz_localize\': <cyfunction Timestamp.tz_localize at 0x000001A4FF6576B0>, \'tz_convert\': <cyfunction Timestamp.tz_convert at 0x000001A4FF6577A0>, \'astimezone\': <cyfunction Timestamp.tz_convert at 0x000001A4FF6577A0>, \'replace\': <cyfunction Timestamp.replace at 0x000001A4FF657890>, \'to_julian_date\': <cyfunction Timestamp.to_julian_date at 0x000001A4FF657980>, \'isoweekday\': <cyfunction Timestamp.isoweekday at 0x000001A4FF657A70>, \'weekday\': <cyfunction Timestamp.weekday at 0x000001A4FF657B60>, \'__dict__\': <attribute \'__dict__\' of \'Timestamp\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Timestamp\' objects>, \'_module_source\': \'pandas._libs.tslibs.timestamps\', \'weekofyear\': <attribute \'week\' of \'pandas._libs.tslibs.timestamps._Timestamp\' objects>, \'daysinmonth\': <attribute \'days_in_month\' of \'pandas._libs.tslibs.timestamps._Timestamp\' objects>})'

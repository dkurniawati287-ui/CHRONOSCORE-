# encoding: utf-8
# module _asyncio
# from C:\Users\T14\AppData\Local\Programs\Python\Python314\DLLs\_asyncio.pyd
# by generator 1.147
...
def all_tasks(*args, **kwargs): # real signature unknown
...
def future_add_to_awaited_by(*args, **kwargs): # real signature unknown
    """ Record that `fut` is awaited on by `waiter`. """
    pass

def future_discard_from_awaited_by(*args, **kwargs): # real signature unknown
    pass
...
class Future(object):
    ...
    _asyncio_awaited_by = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000023C5DF88050>'

__spec__ = None # (!) real value is "ModuleSpec(name='_asyncio', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000023C5DF88050>, origin='C:\\\\Users\\\\T14\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python314\\\\DLLs\\\\_asyncio.pyd')"

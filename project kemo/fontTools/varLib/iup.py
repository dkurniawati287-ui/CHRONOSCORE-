...
# from C:\Users\T14\PyCharmMiscProject\.venv\Lib\site-packages\fontTools\varLib\iup.cp314-win_amd64.pyd
# by generator 1.147
# no doc
...
class Real(__numbers.Complex):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x000001599A744580>'
    __abstractmethods__ = frozenset({'__rfloordiv__', '__rmod__', '__le__', '__pow__', '__round__', '__rpow__', '__rmul__', '__floor__', '__eq__', '__mod__', '__float__', '__mul__', '__add__', '__abs__', '__radd__', '__truediv__', '__lt__', '__ceil__', '__rtruediv__', '__trunc__', '__neg__', '__pos__', '__floordiv__'})
    __firstlineno__ = 172
    __slots__ = ()
...
class Integral(__numbers.Rational):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x000001599AFB9B40>'
    __abstractmethods__ = frozenset({'__rfloordiv__', '__pow__', '__rmod__', '__le__', '__round__', '__rpow__', '__ror__', '__rmul__', '__rxor__', '__int__', '__floor__', '__eq__', '__mod__', '__and__', '__or__', '__lshift__', '__xor__', '__mul__', '__add__', '__rrshift__', '__invert__', '__abs__', '__radd__', '__truediv__', '__lt__', '__ceil__', '__rtruediv__', '__rshift__', '__trunc__', '__neg__', '__rand__', '__pos__', '__floordiv__', '__rlshift__'})
    __firstlineno__ = 319
    __slots__ = ()
    __static_attributes__ = ()
...
_DeltaOrNone = None # (!) real value is 'typing.Tuple[numbers.Real, numbers.Real] | None'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001599CC8C160>'

__spec__ = None # (!) real value is "ModuleSpec(name='fontTools.varLib.iup', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001599CC8C160>, origin='C:\\\\Users\\\\T14\\\\PyCharmMiscProject\\\\.venv\\\\Lib\\\\site-packages\\\\fontTools\\\\varLib\\\\iup.cp314-win_amd64.pyd')"

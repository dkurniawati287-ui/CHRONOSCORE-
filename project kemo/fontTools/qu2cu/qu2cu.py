...
# from C:\Users\T14\PyCharmMiscProject\.venv\Lib\site-packages\fontTools\qu2cu\qu2cu.cp314-win_amd64.pyd
# by generator 1.147
# no doc
...
def quadratic_to_curves(list_quads, List=None, Point=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
    quadratic_to_curves(list quads: List[List[Point]], double max_err: float = 0.5, bool all_cubic: bool = False) -> List[Tuple[Point, ...]]
...
def _raise_incompatible_point(point, previous_point): # real signature unknown; restored from __doc__
    """ _raise_incompatible_point(point, previous_point) """
    pass

def _validate_positive_tolerance(max_err): # real signature unknown; restored from __doc__
    """ _validate_positive_tolerance(max_err) """
    pass

def _validate_spline_length(spline): # real signature unknown; restored from __doc__
...
Point = None # (!) real value is 'typing.Tuple[float, float] | complex'

__all__ = [
    'quadratic_to_curves',
]

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020626632AD0>'

__spec__ = None # (!) real value is "ModuleSpec(name='fontTools.qu2cu.qu2cu', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020626632AD0>, origin='C:\\\\Users\\\\T14\\\\PyCharmMiscProject\\\\.venv\\\\Lib\\\\site-packages\\\\fontTools\\\\qu2cu\\\\qu2cu.cp314-win_amd64.pyd')"

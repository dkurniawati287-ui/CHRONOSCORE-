...
class ParamSpec(object):
    ...
    evaluate_default = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    __default__ = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class TypeAliasType(object):
    ...
    evaluate_value = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class TypeVar(object):
    ...
    evaluate_bound = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    evaluate_constraints = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
class __loader__(object):
    ...
    _ORIGIN = 'built-in'
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_frozen_importlib', '__firstlineno__': 974, '__doc__': 'Meta path import for built-in modules.\\n\\nAll methods are either class or static methods to avoid the need to\\ninstantiate the class.\\n\\n', '_ORIGIN': 'built-in', 'find_spec': <classmethod(<function BuiltinImporter.find_spec at 0x000002073653AB90>)>, 'create_module': <staticmethod(<function BuiltinImporter.create_module at 0x000002073653AC40>)>, 'exec_module': <staticmethod(<function BuiltinImporter.exec_module at 0x000002073653ACF0>)>, 'get_code': <classmethod(<function BuiltinImporter.get_code at 0x000002073653AE50>)>, 'get_source': <classmethod(<function BuiltinImporter.get_source at 0x000002073653AFB0>)>, 'is_package': <classmethod(<function BuiltinImporter.is_package at 0x000002073653B110>)>, 'load_module': <classmethod(<function _load_module_shim at 0x0000020736539DD0>)>, '__static_attributes__': (), '__dict__': <attribute '__dict__' of 'BuiltinImporter' objects>, '__weakref__': <attribute '__weakref__' of 'BuiltinImporter' objects>})"
    __firstlineno__ = 974
...
NoDefault = None # (!) real value is 'typing.NoDefault'
